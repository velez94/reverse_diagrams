...
from aws.describe_sso import list_instances, list_account_assignments
...
def main() -> int:
    ...
    parser.add_argument("-o", "--graph_organization",
                        help="Set if you want to create graph for your organization", default=False)
    parser.add_argument("-i", "--graph_identity",
                            help="Set if you want to create graph for your IAM Center", default=False)
